...
export function Navbar() {
    ...
    return (
        <>
            <nav className="fixed top-0 w-full z-50 backdrop-blur-md bg-white/80 dark:bg-black/80 border-b border-gray-100 dark:border-zinc-800 pr-[var(--removed-body-scroll-bar-size)] transition-all duration-300">
